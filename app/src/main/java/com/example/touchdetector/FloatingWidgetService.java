...
public class FloatingWidgetService extends Service {
    public static final String ACTION_DATA_UPDATED = "com.example.TouchDetector.ACTION_DATA_UPDATED";
    public static final String EXTRA_DATA_X = "data_x_key";
...
//                        destroyOnFling(touchX, touchY);
    ...
    private void destroyFloatingWidget() {
        if (coordinatesView != null && horizontalView != null && verticalView != null && floatingView != null){
            ...
            Intent intent = new Intent(FloatingWidgetService.this, MyAccessibilityService.class);
            startService(intent);
